        ...
        <button
          ...
          className={
            currentLocale === loc
              ...
              : "px-3.5 py-1.5 rounded-full border text-[13px] font-medium cursor-pointer transition-colors bg-white dark:bg-[#1c2028] border-[#eef0f3] dark:border-[#2a2f3d] text-[#6b7280] dark:text-[#8b93a5] hover:border-[#d1d5db] dark:hover:border-[#5c6478] hover:text-[#111827] dark:hover:text-[#e8eaf0]"
          }
